...
url = 'http://192.168.37.254/cam-hi.jpg'

arduino_port = 'COM3'  # Modify this with the appropriate serial port
...
carClassId = classNames.index('person')  # Get the class ID for car
